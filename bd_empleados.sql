...
SELECT CONCAT(UPPER(nombre), ' ', UPPER(apellido1), ' ', UPPER(apellido2)) AS nombre_complet FROM empleados;
...
SELECT codigo,
       ...
       SUBSTRING(nif, 9, 9) AS nif_letra
FROM empleado;

#11.	Lista el nombre de cada departamento y el valor del presupuesto actual del que dispone. Para calcular este dato tendrá que restar al valor 
#del presupuesto inicial (columna presupuesto) los gastos que se han generado (columna gastos). 
...
#15.	Lista los apellidos y el nombre de todos los empleados, ordenados de forma alfabética tendiendo en cuenta en primer lugar sus apellidos
# y luego su nombre.
...
select * from empleado limit 2,13;
#21.	Devuelve una lista con el nombre de los departamentos y el presupuesto, de aquellos que tienen un presupuesto mayor o igual a 150000 euros.
select nombre, presupuesto from departamento where presupuesto >= 150000;
##22.	Devuelve una lista con el nombre de los departamentos y el gasto, de aquellos que tienen menos de 5000 euros de gastos.
select nombre, gastos from departamento where gastos <= 500;
...
select * from empleado where apellido2 in ('dias','moreno');
