...
#unsifned es para no negativo auto increment para ir sumando 1 1
	codigo INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, 
    nombre VARCHAR(100) NOT NULL, 
...
select nombre as "nombre producto", precio as "euros",(precio * 1.07) as dolares from producto;
...
select nombre, upper((nombre,2)) as 'caracteres' from fabricantes;
